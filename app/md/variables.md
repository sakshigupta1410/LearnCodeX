...
## 🖼️ Visual: How Variables Work in Python

### 🔣 Variable Assignment Flow (ASCII Diagram)
...
### 📌 What’s Happening?
- Python sees `x = 5` and creates a variable `x`.
- It stores the value `5` in memory and binds it to the name `x`.
- When you call `print(x)`, Python fetches the value associated with `x`.
